 ...
 * class was taken form our predecessor project
 * @param <T> The domain type this repository manages.
 * @param <ID> The type of the id of the entity this repository manages.
 * @see <a href=https://git.uibk.ac.at/csaw4226/WS2020_PS_SWA_7_1/blob/master/backend/src/main/java/at/ac/uibk/library/backend/repositories/AbstractRepository.java>vue-library</a>
 */
