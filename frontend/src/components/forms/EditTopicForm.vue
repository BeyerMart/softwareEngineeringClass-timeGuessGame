                    ...
                    <div class="mt-2">
                        ...
                        >
                            <div class="form-group">
                                ...
                                <div
                                    v-show="submitted && $v.form.topicName.$error"
                                ...
                                <input
                                    ...
                                    :class="{ 'border-red-500 !important': submitted && $v.form.topicName.$error }"
...
export default {
    ...
    methods: {
        handleSubmit() {
            ...
            editTopic(this.id, this.form.topicName).then((res) => {
                this.$notify({
                    title: this.$t('dashboard.messages.topicEditSuccess'),
                    text: this.$t('dashboard.messages.topicEditSuccessMessage', { topicName: res.data.name }),
                    type: 'success',
                });
                this.$emit('close');
